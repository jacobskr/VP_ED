...
claims <- claims %>%
  mutate(
    BDSYS_0 = ifelse((BODY_SYS_1 == 1) | (BODY_SYS_2 == 1) | (BODY_SYS_3 == 1) |
                       (BODY_SYS_4 == 1) | (BODY_SYS_5 == 1) | (BODY_SYS_6 == 1) |
                       (BODY_SYS_7 == 1) | (BODY_SYS_8 == 1) | (BODY_SYS_9 == 1) |
                       (BODY_SYS_10 == 1) | (BODY_SYS_11 == 1) | (BODY_SYS_12 == 1) |
                       (BODY_SYS_13 == 1) | (BODY_SYS_14 == 1) | (BODY_SYS_15 == 1) |
                       (BODY_SYS_16 == 1) | (BODY_SYS_17 == 1) | (BODY_SYS_18 == 1), 1, 0),
    BDSYS_1 = ifelse((BODY_SYS_1 == 2) | (BODY_SYS_2 == 2) | (BODY_SYS_3 == 2) |
                       (BODY_SYS_4 == 2) | (BODY_SYS_5 == 2) | (BODY_SYS_6 == 2) |
                       (BODY_SYS_7 == 2) | (BODY_SYS_8 == 2) | (BODY_SYS_9 == 2) |
                       (BODY_SYS_10 == 2) | (BODY_SYS_11 == 2) | (BODY_SYS_12 == 2) |
                       (BODY_SYS_13 == 2) | (BODY_SYS_14 == 2) | (BODY_SYS_15 == 2) |
                       (BODY_SYS_16 == 2) | (BODY_SYS_17 == 2) | (BODY_SYS_18 == 2), 1, 0),
    BDSYS_2 = ifelse((BODY_SYS_1 == 3) | (BODY_SYS_2 == 3) | (BODY_SYS_3 == 3) |
                       (BODY_SYS_4 == 3) | (BODY_SYS_5 == 3) | (BODY_SYS_6 == 3) |
                       (BODY_SYS_7 == 3) | (BODY_SYS_8 == 3) | (BODY_SYS_9 == 3) |
                       (BODY_SYS_10 == 3) | (BODY_SYS_11 == 3) | (BODY_SYS_12 == 3) |
                       (BODY_SYS_13 == 3) | (BODY_SYS_14 == 3) | (BODY_SYS_15 == 3) |
                       (BODY_SYS_16 == 3) | (BODY_SYS_17 == 3) | (BODY_SYS_18 == 3), 1, 0),
    BDSYS_3 = ifelse((BODY_SYS_1 == 4) | (BODY_SYS_2 == 4) | (BODY_SYS_3 == 4) |
                       (BODY_SYS_4 == 4) | (BODY_SYS_5 == 4) | (BODY_SYS_6 == 4) |
                       (BODY_SYS_7 == 4) | (BODY_SYS_8 == 4) | (BODY_SYS_9 == 4) |
                       (BODY_SYS_10 == 4) | (BODY_SYS_11 == 4) | (BODY_SYS_12 == 4) |
                       (BODY_SYS_13 == 4) | (BODY_SYS_14 == 4) | (BODY_SYS_15 == 4) |
                       (BODY_SYS_16 == 4) | (BODY_SYS_17 == 4) | (BODY_SYS_18 == 4), 1, 0),
    BDSYS_4 = ifelse((BODY_SYS_1 == 5) | (BODY_SYS_2 == 5) | (BODY_SYS_3 == 5) |
                       (BODY_SYS_4 == 5) | (BODY_SYS_5 == 5) | (BODY_SYS_6 == 5) |
                       (BODY_SYS_7 == 5) | (BODY_SYS_8 == 5) | (BODY_SYS_9 == 5) |
                       (BODY_SYS_10 == 5) | (BODY_SYS_11 == 5) | (BODY_SYS_12 == 5) |
                       (BODY_SYS_13 == 5) | (BODY_SYS_14 == 5) | (BODY_SYS_15 == 5) |
                       (BODY_SYS_16 == 5) | (BODY_SYS_17 == 5) | (BODY_SYS_18 == 5), 1, 0),
    BDSYS_5 = ifelse((BODY_SYS_1 == 6) | (BODY_SYS_2 == 6) | (BODY_SYS_3 == 6) |
                       (BODY_SYS_4 == 6) | (BODY_SYS_5 == 6) | (BODY_SYS_6 == 6) |
                       (BODY_SYS_7 == 6) | (BODY_SYS_8 == 6) | (BODY_SYS_9 == 6) |
                       (BODY_SYS_10 == 6) | (BODY_SYS_11 == 6) | (BODY_SYS_12 == 6) |
                       (BODY_SYS_13 == 6) | (BODY_SYS_14 == 6) | (BODY_SYS_15 == 6) |
                       (BODY_SYS_16 == 6) | (BODY_SYS_17 == 6) | (BODY_SYS_18 == 6), 1, 0),
    BDSYS_6 = ifelse((BODY_SYS_1 == 7) | (BODY_SYS_2 == 7) | (BODY_SYS_3 == 7) |
                       (BODY_SYS_4 == 7) | (BODY_SYS_5 == 7) | (BODY_SYS_6 == 7) |
                       (BODY_SYS_7 == 7) | (BODY_SYS_8 == 7) | (BODY_SYS_9 == 7) |
                       (BODY_SYS_10 == 7) | (BODY_SYS_11 == 7) | (BODY_SYS_12 == 7) |
                       (BODY_SYS_13 == 7) | (BODY_SYS_14 == 7) | (BODY_SYS_15 == 7) |
                       (BODY_SYS_16 == 7) | (BODY_SYS_17 == 7) | (BODY_SYS_18 == 7), 1, 0),
    BDSYS_7 = ifelse((BODY_SYS_1 == 8) | (BODY_SYS_2 == 8) | (BODY_SYS_3 == 8) |
                       (BODY_SYS_4 == 8) | (BODY_SYS_5 == 8) | (BODY_SYS_6 == 8) |
                       (BODY_SYS_7 == 8) | (BODY_SYS_8 == 8) | (BODY_SYS_9 == 8) |
                       (BODY_SYS_10 == 8) | (BODY_SYS_11 == 8) | (BODY_SYS_12 == 8) |
                       (BODY_SYS_13 == 8) | (BODY_SYS_14 == 8) | (BODY_SYS_15 == 8) |
                       (BODY_SYS_16 == 8) | (BODY_SYS_17 == 8) | (BODY_SYS_18 == 8), 1, 0),
    BDSYS_8 = ifelse((BODY_SYS_1 == 9) | (BODY_SYS_2 == 9) | (BODY_SYS_3 == 9) |
                       (BODY_SYS_4 == 9) | (BODY_SYS_5 == 9) | (BODY_SYS_6 == 9) |
                       (BODY_SYS_7 == 9) | (BODY_SYS_8 == 9) | (BODY_SYS_9 == 9) |
                       (BODY_SYS_10 == 9) | (BODY_SYS_11 == 9) | (BODY_SYS_12 == 9) |
                       (BODY_SYS_13 == 9) | (BODY_SYS_14 == 9) | (BODY_SYS_15 == 9) |
                       (BODY_SYS_16 == 9) | (BODY_SYS_17 == 9) | (BODY_SYS_18 == 9), 1, 0),
    BDSYS_9 = ifelse((BODY_SYS_1 == 10) | (BODY_SYS_2 == 10) | (BODY_SYS_3 == 10) |
                       (BODY_SYS_4 == 10) | (BODY_SYS_5 == 10) | (BODY_SYS_6 == 10) |
                       (BODY_SYS_7 == 10) | (BODY_SYS_8 == 10) | (BODY_SYS_9 == 10) |
                       (BODY_SYS_10 == 10) | (BODY_SYS_11 == 10) | (BODY_SYS_12 == 10) |
                       (BODY_SYS_13 == 10) | (BODY_SYS_14 == 10) | (BODY_SYS_15 == 10) |
                       (BODY_SYS_16 == 10) | (BODY_SYS_17 == 10) | (BODY_SYS_18 == 10), 1, 0),
    BDSYS_10 = ifelse((BODY_SYS_1 == 11) | (BODY_SYS_2 == 11) | (BODY_SYS_3 == 11) |
                        (BODY_SYS_4 == 11) | (BODY_SYS_5 == 11) | (BODY_SYS_6 == 11) |
                        (BODY_SYS_7 == 11) | (BODY_SYS_8 == 11) | (BODY_SYS_9 == 11) |
                        (BODY_SYS_10 == 11) | (BODY_SYS_11 == 11) | (BODY_SYS_12 == 11) |
                        (BODY_SYS_13 == 11) | (BODY_SYS_14 == 11) | (BODY_SYS_15 == 11) |
                        (BODY_SYS_16 == 11) | (BODY_SYS_17 == 11) | (BODY_SYS_18 == 11), 1, 0),
    BDSYS_11 = ifelse((BODY_SYS_1 == 12) | (BODY_SYS_2 == 12) | (BODY_SYS_3 == 12) |
                        (BODY_SYS_4 == 12) | (BODY_SYS_5 == 12) | (BODY_SYS_6 == 12) |
                        (BODY_SYS_7 == 12) | (BODY_SYS_8 == 12) | (BODY_SYS_9 == 12) |
                        (BODY_SYS_10 == 12) | (BODY_SYS_11 == 12) | (BODY_SYS_12 == 12) |
                        (BODY_SYS_13 == 12) | (BODY_SYS_14 == 12) | (BODY_SYS_15 == 12) |
                        (BODY_SYS_16 == 12) | (BODY_SYS_17 == 12) | (BODY_SYS_18 == 12), 1, 0),
    BDSYS_12 = ifelse((BODY_SYS_1 == 13) | (BODY_SYS_2 == 13) | (BODY_SYS_3 == 13) |
                        (BODY_SYS_4 == 13) | (BODY_SYS_5 == 13) | (BODY_SYS_6 == 13) |
                        (BODY_SYS_7 == 13) | (BODY_SYS_8 == 13) | (BODY_SYS_9 == 13) |
                        (BODY_SYS_10 == 13) | (BODY_SYS_11 == 13) | (BODY_SYS_12 == 13) |
                        (BODY_SYS_13 == 13) | (BODY_SYS_14 == 13) | (BODY_SYS_15 == 13) |
                        (BODY_SYS_16 == 13) | (BODY_SYS_17 == 13) | (BODY_SYS_18 == 13), 1, 0),
    BDSYS_13 = ifelse((BODY_SYS_1 == 14) | (BODY_SYS_2 == 14) | (BODY_SYS_3 == 14) |
                        (BODY_SYS_4 == 14) | (BODY_SYS_5 == 14) | (BODY_SYS_6 == 14) |
                        (BODY_SYS_7 == 14) | (BODY_SYS_8 == 14) | (BODY_SYS_9 == 14) |
                        (BODY_SYS_10 == 14) | (BODY_SYS_11 == 14) | (BODY_SYS_12 == 14) |
                        (BODY_SYS_13 == 14) | (BODY_SYS_14 == 14) | (BODY_SYS_15 == 14) |
                        (BODY_SYS_16 == 14) | (BODY_SYS_17 == 14) | (BODY_SYS_18 == 14), 1, 0),
    BDSYS_14 = ifelse((BODY_SYS_1 == 15) | (BODY_SYS_2 == 15) | (BODY_SYS_3 == 15) |
                        (BODY_SYS_4 == 15) | (BODY_SYS_5 == 15) | (BODY_SYS_6 == 15) |
                        (BODY_SYS_7 == 15) | (BODY_SYS_8 == 15) | (BODY_SYS_9 == 15) |
                        (BODY_SYS_10 == 15) | (BODY_SYS_11 == 15) | (BODY_SYS_12 == 15) |
                        (BODY_SYS_13 == 15) | (BODY_SYS_14 == 15) | (BODY_SYS_15 == 15) |
                        (BODY_SYS_16 == 15) | (BODY_SYS_17 == 15) | (BODY_SYS_18 == 15), 1, 0),
    BDSYS_15 = ifelse((BODY_SYS_1 == 16) | (BODY_SYS_2 == 16) | (BODY_SYS_3 == 16) |
                        (BODY_SYS_4 == 16) | (BODY_SYS_5 == 16) | (BODY_SYS_6 == 16) |
                        (BODY_SYS_7 == 16) | (BODY_SYS_8 == 16) | (BODY_SYS_9 == 16) |
                        (BODY_SYS_10 == 16) | (BODY_SYS_11 == 16) | (BODY_SYS_12 == 16) |
                        (BODY_SYS_13 == 16) | (BODY_SYS_14 == 16) | (BODY_SYS_15 == 16) |
                        (BODY_SYS_16 == 16) | (BODY_SYS_17 == 16) | (BODY_SYS_18 == 16), 1, 0),
    BDSYS_16 = ifelse((BODY_SYS_1 == 17) | (BODY_SYS_2 == 17) | (BODY_SYS_3 == 17) |
                        (BODY_SYS_4 == 17) | (BODY_SYS_5 == 17) | (BODY_SYS_6 == 17) |
                        (BODY_SYS_7 == 17) | (BODY_SYS_8 == 17) | (BODY_SYS_9 == 17) |
                        (BODY_SYS_10 == 17) | (BODY_SYS_11 == 17) | (BODY_SYS_12 == 17) |
                        (BODY_SYS_13 == 17) | (BODY_SYS_14 == 17) | (BODY_SYS_15 == 17) |
                        (BODY_SYS_16 == 17) | (BODY_SYS_17 == 17) | (BODY_SYS_18 == 17), 1, 0),
    BDSYS_17 = ifelse((BODY_SYS_1 == 18) | (BODY_SYS_2 == 18) | (BODY_SYS_3 == 18) |
                        (BODY_SYS_4 == 18) | (BODY_SYS_5 == 18) | (BODY_SYS_6 == 18) |
                        (BODY_SYS_7 == 18) | (BODY_SYS_8 == 18) | (BODY_SYS_9 == 18) |
                        (BODY_SYS_10 == 18) | (BODY_SYS_11 == 18) | (BODY_SYS_12 == 18) |
                        (BODY_SYS_13 == 18) | (BODY_SYS_14 == 18) | (BODY_SYS_15 == 18) |
                        (BODY_SYS_16 == 18) | (BODY_SYS_17 == 18) | (BODY_SYS_18 == 18), 1, 0),
    BDSYS_18 = ifelse((BODY_SYS_1 == 19) | (BODY_SYS_2 == 19) | (BODY_SYS_3 == 19) |
                        (BODY_SYS_4 == 19) | (BODY_SYS_5 == 19) | (BODY_SYS_6 == 19) |
                        (BODY_SYS_7 == 19) | (BODY_SYS_8 == 19) | (BODY_SYS_9 == 19) |
                        (BODY_SYS_10 == 19) | (BODY_SYS_11 == 19) | (BODY_SYS_12 == 19) |
                        (BODY_SYS_13 == 19) | (BODY_SYS_14 == 19) | (BODY_SYS_15 == 19) |
                        (BODY_SYS_16 == 19) | (BODY_SYS_17 == 19) | (BODY_SYS_18 == 19), 1, 0),
    BDSYS_NONE = ifelse((BODY_SYS_1 == 20) | (BODY_SYS_2 == 20) | (BODY_SYS_3 == 20) |
                          (BODY_SYS_4 == 20) | (BODY_SYS_5 == 20) | (BODY_SYS_6 == 20) |
                          (BODY_SYS_7 == 20) | (BODY_SYS_8 == 20) | (BODY_SYS_9 == 20) |
                          (BODY_SYS_10 == 20) | (BODY_SYS_11 == 20) | (BODY_SYS_12 == 20) |
                          (BODY_SYS_13 == 20) | (BODY_SYS_14 == 20) | (BODY_SYS_15 == 20) |
                          (BODY_SYS_16 == 20) | (BODY_SYS_17 == 20) | (BODY_SYS_18 == 20), 1, 0)
  )
...
saveRDS(claims, "Data/CHRON_MBR_FULL.RDS")
library(tidyverse)
claims <- readRDS('data/CHRON_MBR_FULL.rds')
...
claims_sub <- claims %>%
  mutate(TARGET = ifelse(SERVICE_TYPE == "ED" & ED_NOT_NEEDED_PROP > 0.9, 1, 0),
         MEMBER_SEX = ifelse(MEMBER_SEX == "M", "MALE", "FEMALE")) %>%
  group_by(MRN_ALIAS, MEMBER_SEX) %>%
  summarize(TARGET = as.factor(max(TARGET)),
            PCP_V70_YEARLY_NONED = as.factor(ifelse((sum(PCP_ID == VENDOR_PROV_ID | (CODE_1 == "V700" & SERVICE_TYPE != "ED"))/n_distinct(YEAR))>=1,"Y","N")),
            MAX_AGE = max(MEMBER_AGE),
            AGE_BIN = as.factor(round(MAX_AGE, - 1)),
...
claims_sub$MEMBER_SEX <- as.factor(claims_sub$MEMBER_SEX)

#Only run if don't need claims data anymore:
# rm(claims)
# gc()

saveRDS(claims, file = "Data/CHRON_MBR_FULL_BODY_SYS.rds")
